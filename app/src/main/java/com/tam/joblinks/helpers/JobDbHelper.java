...
public class JobDbHelper extends SQLiteOpenHelper {
    ...
    private static final String COL_JOB_CITY = "city";
    private static final String COL_OBJECT_ID = "objectId";
    private static final String COL_TITLE = "title";
    private static final String COL_CREATED_DATE = "createdDate";
    private static final String COL_EXPIRATION_DATE = "expirationDate";
    private static final String COL_MAX_SALARY = "maxSalary";
    private static final String COL_SALARY = "salary";
    private static final String COL_MIN_SALARY = "minSalary";
